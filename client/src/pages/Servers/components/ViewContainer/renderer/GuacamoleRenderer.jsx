...
const GuacamoleRenderer = ({
    ...
    const connect = () => {
        ...
        if (isShared) {
            connectionString = `shareId=${session.shareId}`;
        } else {
            ...
            connectionString = session.connectionReason
        ...
        keyboard.onkeydown = (keysym, keycode) => client.sendKeyEvent(1, keysym, keycode);
        keyboard.onkeyup = (keysym, keycode) => client.sendKeyEvent(0, keysym, keycode);
